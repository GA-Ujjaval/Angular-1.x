(function () {
  ...
  function MsNavigationController($scope, msNavigationService, $rootScope) {
    ...
    vm.linkTarget = '_self';
    vm.navigation = $scope.root ? msNavigationService.getNavigation($scope.root) : msNavigationService.getNavigation();
