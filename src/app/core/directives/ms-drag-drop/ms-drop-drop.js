...
(function ()
{
    ...
    angular
        .module('app.core')
        .directive('mdDragColumn', mdDragColumn)
        .directive('mdDropColumn', mdDropColumn);


    function mdDragColumn(){
        return {
        ...
        return {
            link: function (scope, element, attrs) {
                ...
                var ghostTable = function (direction, index) {
                    ...
                    var $currentElements = element.closest('table').find('>tbody>tr td:nth-child(' + (index) + ')');;
