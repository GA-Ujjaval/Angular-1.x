(function () {
  ...
  angular
    .module('app.objects')
    .controller('SupplierAttachmentController', SupplierAttachmentController);

  /** @ngInject */
  function SupplierAttachmentController($state, $mdDialog, Sourcing, hostUrlDevelopment, CustomerService, errors, $mdToast, AuthService, objectId) {
    ...
    //For Global Variable-------------------------------------------------------------------------------------------
    var params;
    vm.Supplierattachments = Sourcing.attachmentsList;
              ...
              case 0:
                ...
                angular.forEach(response.data.sourcingList, function (value, key) {
                  if (value.type === "supplier") {
                    vm.Supplierattachments = value.attachmentsList;
                  }
                });
                break;
              case 1006:
