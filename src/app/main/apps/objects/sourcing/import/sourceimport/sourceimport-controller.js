(function () {
  ...
  angular
    .module('app.objects')
    .controller('sourceimportController', sourceimportController)
  ...
  /** @ngInject */
  function sourceimportController($scope, $timeout, $rootScope, $state, $http, $stateParams, hostUrlDevelopment, CustomerService, errors, $mdToast, AuthService, $document, introService, $mdDialog) {
    ...
    if (id === 'manufacturersparts') {
      id = '';
      vm.type = 'mfrpart';
      vm.importName = 'Manufacturer Part';
      vm.importHeading = 'Manufacturer Part';
      vm.partproductbom = 'Manufacturer';
      vm.matchingRecordsNotShow = true;
      vm.showhideBasicinfo = true;
      vm.showhideAdditionalinfo = false;
      vm.showhideCost = false;
      vm.showhideInventory = false;
      vm.message1 = "There’re no formulas in the spreadsheet for 'Manufacturer Part Number' and 'Manufacturer Name'."
    } else {
      id = '';
      vm.type = 'supppart';
      vm.importName = 'Supplier Part';
      vm.importHeading = 'Supplier Part';
      ...
      vm.showhideCost = false;
      vm.showhideInventory = false;
      vm.message1 = "There’re no formulas in the spreadsheet for 'Supplier Number' and 'Supplier Name'.";
    }
        ...
        case 2:
          ...
          if (mapping === '') {
            ...
            data = {
              ...
              available: vm.basicInfo.available,
              description: vm.basicInfo.description,
              packaging: vm.basicInfo.packaging,
              leadTime: vm.basicInfo.leadTime,
              tags: vm.basicInfo.tags,
              sourceCost: {
                id: 'M',
                moq: vm.sourceCost.moq,
                currency: vm.sourceCost.currency,
                cost: vm.sourceCost.cost
              },
              sourceInventory: {
                qtyOnHand: vm.sourceInventory.qtyOnHand,
                qtyOnOrder: vm.sourceInventory.qtyOnOrder
              },
