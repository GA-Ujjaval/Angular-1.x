(function () {
  ...
  /** @ngInject */
  function routeConfig($stateProvider, $urlRouterProvider, $locationProvider, $compileProvider, $provide) {
    $compileProvider.debugInfoEnabled(false);

    $locationProvider.html5Mode(true);

    //$urlRouterProvider.otherwise('/landing');
    $urlRouterProvider.otherwise('/login/aws');
    ...
    var layouts = {
      ...
      contentWithToolbarAdmin: {
        main: 'app/core/layouts/content-with-toolbar-admin.html',
        toolbar: 'app/toolbar/layouts/content-with-toolbar-admin/toolbar.html',
        navigation: ''
      }
    };
